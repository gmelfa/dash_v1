...
## Corpus Check
- Corpus is ~45,189 words - fits in a single context window. You may not need a graph.

## Summary
- 307 nodes · 362 edges · 35 communities (30 shown, 5 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 35 edges (avg confidence: 0.86)
- Token cost: 237,000 input · 25,470 output
...
- **Why does `QueryLoader` connect `Query Loader Service` to `PPTX Export (Single)`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `export_batch()` connect `PPTX Export (Single)` to `Query Loader Service`?**
