-- @id: premium_dre_pueri_domus_verbo
-- @name: Premium - DRE YTD - Pueri Domus Verbo
-- @category: Premium
-- @order: 24

-- ============================================================================
-- DRE PUERI DOMUS VERBO YTD
-- Demonstrativo de Resultado do Exercício para a unidade Pueri Domus Verbo
-- Mesma lógica/mapeamento da query premium_dre_pueri_domus, só filtrada
-- pra uma única unidade (idEstFiscal = '1012') em vez do grupo inteiro
...
SELECT 'Receitas com Ensino Regular',
    ROUND(ens_reg_25r, 0), NULL,
    ROUND(ens_reg_26f, 0), NULL,
    ROUND(ens_reg_26r, 0), NULL,
...
SELECT 'Receitas com UpSelling',
    ROUND(upsell_25r, 0), NULL,
    ROUND(upsell_26f, 0), NULL,
    ROUND(upsell_26r, 0), NULL,
...
SELECT '(=) Receita de Ensino Bruta',
    ROUND(rec_bruta_25r, 0), NULL,
    ROUND(rec_bruta_26f, 0), NULL,
    ROUND(rec_bruta_26r, 0), NULL,
...
SELECT 'Bolsa de Estudos',
    ROUND(bolsa_25r, 0), NULL,
    ROUND(bolsa_26f, 0), NULL,
    ROUND(bolsa_26r, 0), NULL,
...
SELECT '(=) Receita de Ensino',
    ROUND(rec_ensino_tot_25r, 0), NULL,
    ROUND(rec_ensino_tot_26f, 0), NULL,
    ROUND(rec_ensino_tot_26r, 0), NULL,
...
SELECT 'Descontos Método de Assinatura',
    ROUND(met_ass_25r, 0), NULL,
    ROUND(met_ass_26f, 0), NULL,
    ROUND(met_ass_26r, 0), NULL,
...
SELECT 'Receita com Material Didático',
    ROUND(mat_did_25r, 0), NULL,
    ROUND(mat_did_26f, 0), NULL,
    ROUND(mat_did_26r, 0), NULL,
...
SELECT 'Receita com Eventos',
    ROUND(ev_rec_25r, 0), NULL,
    ROUND(ev_rec_26f, 0), NULL,
    ROUND(ev_rec_26r, 0), NULL,
...
SELECT 'Outras Receitas',
    ROUND(outras_rec_25r, 0), NULL,
    ROUND(outras_rec_26f, 0), NULL,
    ROUND(outras_rec_26r, 0), NULL,
...
SELECT 'Bolsa de Colaborador',
    ROUND(bolsa_colab_25r, 0), NULL,
    ROUND(bolsa_colab_26f, 0), NULL,
    ROUND(bolsa_colab_26r, 0), NULL,
...
SELECT '(=) ROL antes das deduções',
    ROUND(rol_antes_ded_25r, 0), NULL,
    ROUND(rol_antes_ded_26f, 0), NULL,
    ROUND(rol_antes_ded_26r, 0), NULL,
...
-- 14. Deduções
SELECT 'Deduções',
    ROUND(deducoes_25r, 0), NULL,
    ROUND(deducoes_26f, 0), NULL,
    ROUND(deducoes_26r, 0), NULL,
...
-- 15. (=) ROL
SELECT '(=) ROL',
    ROUND(rol_25r, 0), NULL,
    ROUND(rol_26f, 0), NULL,
    ROUND(rol_26r, 0), NULL,
