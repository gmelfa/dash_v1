-- @id: premium_dre_pueri_domus
-- @name: Premium - DRE YTD - Pueri Domus
-- @category: Premium
-- @order: 15

-- ============================================================================
-- DRE PUERI DOMUS YTD
-- Demonstrativo de Resultado do Exercício para o grupo Pueri Domus (Vertical Premium)
-- Mesma lógica/mapeamento da query premium_dre_ytd, só com filtro de Grupo adicionado
