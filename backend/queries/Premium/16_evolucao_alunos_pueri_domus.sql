-- @id: premium_evolucao_alunos_pueri_domus
-- @name: Premium - Evolução de Alunos YTD - Pueri Domus
-- @category: Premium
-- @order: 16

-- ============================================================
-- Evolução de Alunos — Pueri Domus
-- Mesma lógica da premium_historico_alunos, filtrada para Grupo = 'Pueri Domus'
-- (exclui Ipiranga, ainda pré-operacional)
...
fcst_real_base AS (
    ...
    WHERE fr.Vertical = 'Premium'
      AND fr.Grupo = 'Pueri Domus'
      AND fr.idEstFiscal != '1040'
