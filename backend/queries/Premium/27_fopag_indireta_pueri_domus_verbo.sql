-- @id: premium_fopag_indireta_pueri_domus_verbo
-- @name: Premium - FOPAG Indireta YTD - Pueri Domus Verbo
-- @category: Premium
-- @order: 27
...
itens AS (
    SELECT
        ...
        , 1)                                                                                                                                  AS `Var_pp_FcstR`,
        -- Ordem específica do print Pueri Domus (Prêmio antes do 13º Salário,
        -- difere da Premium consolidado)
        CASE m.Nome_Conta
